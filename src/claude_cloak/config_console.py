...
CONFIG_SPECS: list[dict] = [
    ...
    {
        "key": "PROXY_KEYS_ENABLED",
        "var": "PROXY_KEYS_ENABLED",
        "type": "bool",
        "scope": "locked",
        "section": "Access control",
        "desc": "Accept proxy keys (/k/<key>/… or the key header) as a second door beside ALLOWED_IPS. Locked: it widens who can reach the proxy. Issue and revoke the keys themselves at /keys.",
    },
    {
        "key": "PROXY_KEY_BYPASS_IP_ALLOWLIST",
        "var": "PROXY_KEY_BYPASS_IP_ALLOWLIST",
        "type": "bool",
        "scope": "locked",
        "section": "Access control",
        "desc": "A valid key admits its holder from any address. False makes a key label the user without granting access, leaving ALLOWED_IPS the only gate.",
    },
    {
        "key": "PROXY_KEY_URL_SEGMENT",
        "var": "PROXY_KEY_URL_SEGMENT",
        "type": "str",
        "scope": "locked",
        "section": "Access control",
        "desc": "First URL segment that introduces a key. Changing it invalidates every base URL already handed out.",
    },
    {
        "key": "PROXY_KEY_HEADER",
        "var": "PROXY_KEY_HEADER",
        "type": "str",
        "scope": "locked",
        "section": "Access control",
        "desc": "Header a client may present the key in instead of the URL. Never forwarded upstream.",
    },
    {
        "key": "ADMIN_TOKEN",
        "var": "ADMIN_TOKEN",
